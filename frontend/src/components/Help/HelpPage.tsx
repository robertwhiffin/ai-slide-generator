  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-800">How to Use Databricks Storyteller</h1>
        <button
          onClick={onBack}
...
const OverviewTab: React.FC<{
  ...
  <div className="space-y-6">
    <section>
      <h2 className="text-lg font-semibold text-gray-800 mb-3">What is Databricks Storyteller?</h2>
