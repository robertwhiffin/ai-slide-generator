...
class UpdateExternalLocation(BaseModel):
    ...
    new_name: Optional[StrictStr] = Field(default=None, description="New name for the external location.")
    __properties: ClassVar[List[str]] = ["url", "credential_name", "comment", "owner", "new_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateExternalLocation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateExternalLocation from a dict"""
        if obj is None:
            return None
